##Same as adv_heatmap_degradation but putting a tau constant line.
...
#Again, change parameters to have a different heatmap, right now is a vs Delta
m_values = [5]  #de 3 a 7
a_values = np.linspace(0.2, 0.6, 33)
q1_values = [0.03]
q2_values = [0.03]
...
p2_line = np.linspace(p2_values[0], p2_values[-1], 100)
p1_line = q1_val * (p2_line) / tau_constant 
