##Generic heatmap simulation

##Takes a lot of time (hours), and was used to try the heatmap generating programmes, not really used in the end
...
#Here we determine what parameters are composing the heatmap.
#In the current case, we have a q1 vs q2 heatmap. Changing these parameters to others yield other heatmaps
m_values = [5]
a_values = [0.405]
...
for a, m, q1, q2, Delta, k3, mu in tqdm(product(a_values, m_values, q1_values, q2_values, Delta_values, k3_values, mu_values)):
