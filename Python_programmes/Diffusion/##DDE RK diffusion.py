...
t_span = (0, 1000)           
dt = 0.01                    # Si cambiamos el step, hay que cambiar el round(tau, 2)
...
t_spanDDE = (0, 300)           
dtDDE = 0.001                    # Si cambiamos el step, hay que cambiar el round(tau, 2)
...
#     plt.plot(time, X[:, j], label=f"X(t) for mu={mu}")
#     plt.plot(time, Y[:, j], label=f"Y(t) for mu={mu}")
# plt.xlabel("Time")
# plt.ylabel("Values")
# plt.title("X(t) and Y(t) for Different Mu Values with Integral")
# plt.legend()
# plt.grid()
...
# plt.subplot(3, 1, 1)
# #plt.plot(time, X[:, 1], label=f"X(t), μ = 0.03", color='r', linestyle= 'dashed')
# plt.plot(time, X[:, 0], label=f"X(t), μ = 0", color='b')
# ##plt.plot(l_eval_reescaled, s1, label=f'DDE ddeint', color='black')

# plt.xlabel("t")
# plt.ylabel("X")
# plt.title("Time series of x(l)")
# plt.legend()
# plt.grid()


# plt.subplot(3, 1, 2)
# plt.plot(time, Yprima[:, 0], label=f"Ydelta(t), μ = 0", color='r')
# plt.xlabel("t")
# plt.ylabel("Y")
...
# plt.subplot(3, 1, 3)
# #plt.plot(time, X[:, 1], label=f"X(t), μ = 0.03", color='r', linestyle= 'dashed')
# plt.plot(time, Y[:,0], label=f"Ydelta(t), μ = 0", color='r')
...
# plt.subplot(3, 1, 4)
# plt.plot(time, ker3[:, 0], label=f"precomputed sum(t), μ = 0", color='r')


# plt.xlabel("t")
# plt.ylabel("Y")
# plt.title("precomputed sum")
# plt.legend()
# plt.grid()
...
# plt.plot(timeDDE_reescaled, Y[:, 0], label=f"y(l), μ = 0", color='r', linestyle='dashed')
# plt.plot(timeDDE_reescaled, Y[:, 1], label=f"y(l), μ = 0.03", color='b', linestyle='.-')
# ##plt.plot(l_eval_reescaled, s1, label=f'DDE ddeint', color='black')
# plt.xlabel("t")
# plt.ylabel("Y")
# plt.title("Time series of y(l)")
# plt.legend()
# plt.grid()
