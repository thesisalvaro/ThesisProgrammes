...
k2 = 0.08
D = 0.1
mu = 0.03            ##ADD SOME DEGRADATION FOR THE SECOND HEATMAP
Delta = 4.5

#lo que está corriendo es con deg, queremos ver si esta ventana está bien para dejarla luego esta noche.
...
t_span = (0, 3000)           # Time range for simulation
dt = 0.01     
